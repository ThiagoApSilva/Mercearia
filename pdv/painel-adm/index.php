...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand text-light" href="index.php" style="margin-left: 30px;">
      <!-- imagem ou nome para navebar 
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="color: #FFFFFF;">
        <li class="nav-item">
          <a class="nav-link active text-light" aria-current="page" href="index.php?pagina=<?php echo $menu1 ?>">Home</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link text-light" href="index.php?pagina=<?php echo $menu7 ?>">Caixas</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-light" href="index.php?pagina=<?php echo $menu8 ?>">Forma PGTOS</a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link text-light" href="index.php?pagina=<?php echo $menu9 ?>">Contas em Aberto</a>
        </li>
