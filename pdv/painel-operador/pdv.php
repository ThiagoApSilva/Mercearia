...
<head>
  ...
  <title>PDV Mercearia Valdir</title>
        ...
        <form method="post" id="form-buscar">
          <div class="row py-2">
            ...
            <div class="col-md-5">
              ...
              <input type="hidden" name="nome_input" id="nome_input">
...
<section class="container">
    ...
    <table id="example" class="table table-hover my-4" style=" text-align: center; background-color: #fff;">
      <thead>
        <tr>
          <th colspan="2">
  ...
  $(function(){
    $("#pesquisa").keyup(function(){
      ...
      if(pesquisa != ''){
        ...
        $.post('pesquisa_produtos.php', dados, function(retorna){
...
<div class="modal fade" tabindex="-1" id="modalVenda" >
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" id="form-fechar-venda" action="#">
        <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-6">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="cpf" id="cpf" placeholder="xxx.xxx.xxx-xx" onkeypress="$(this).mask('000.000.000-00')">
                </div> 
...
<script type="text/javascript">
  $("#form-fechar-venda").submit(function () {
        ...
        var cpf_conta = document.getElementById('cpf').value;
        document.getElementById('cpf_input').value = cpf_conta;

        var nome_conta = document.getElementById('nome').value;
        document.getElementById('nome_input').value = nome_conta;
