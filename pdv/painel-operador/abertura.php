...
$senha_gerente = sha1(trim($_POST['senha_gerente']));
...
$res = $pdo->prepare("INSERT INTO caixa SET data_ab = curDate(), hora_ab = curTime(), valor_ab = :valor_ab, gerente_ab = :gerente_ab, caixa = :caixa, operador = :id_operador, status = 'Aberto'");
$res->bindValue(":valor_ab", $valor_ab);
$res->bindValue(":gerente_ab", $gerente);
$res->bindValue(":caixa", $caixa);
$res->bindValue(":id_operador", $id_usuario);
