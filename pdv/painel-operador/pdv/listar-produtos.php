...
echo '<h1 style="float: left;">R$ <span id="sub_total">'.$total_vendaF.'</span></h1>';
}


 ?>
<a href="verificar-permissao.php" style="float: right;"><img src="../img/voltar.png" style="width:50px; height: auto; margin-top: 10px;"></a>